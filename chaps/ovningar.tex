...
% XX Finns på https://octave.sourceforge.io/symbolic/ men är krångligt att installera
% kolla upp andra funktioner:
% https://se.mathworks.com/help/symbolic/vpasolve.html
% http://octave.sourceforge.net/octave/function/fzero.html
% https://www.gnu.org/software/octave/doc/interpreter/Solvers.html#XREFfsolve
...
% \section{Nåt mer med linjära ekvationssystem}
...
% \begin{matteovning}{xx}{}
% Hitta en andragradsfunktions symmetriaxel / lägsta/högsta värde.
% \end{matteovning}
...
% XX  Skriv ett program som hittar alla maximi- och minimipunkter i en lista?
...
% % Lämplig för Ma1c??? , Ma2c XX dubbelkolla!
